    ...
    <div>
      ...
      <div className="frontAuthRow">
        <div className="firstAuthRowFrontImage">
          <img src="./assets/images/author_book_3.jpg" alt="" />
        </div>
        <div className="frontAuthRowDesc">
          ...
          <p>
            ...
            students of various grades at her coaching institute from the past 8
            years. She did the Certification of ‘Python-Programming’ and
